...
import { FaBath, FaChair, FaMapMarkedAlt, FaParking, FaShare } from 'react-icons/fa';
            ...
            <div>
                ...
                <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
                    ...
                    {currentUser && listing.userRef !== currentUser._id && !contact && (
                        ...
                        className="bg-slate-700 text-white rounded-lg uppercase p-3 hover: opacity-95">Contact Landlord</button>
                    )}
